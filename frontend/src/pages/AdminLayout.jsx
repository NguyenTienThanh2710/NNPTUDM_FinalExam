            ...
            <header className="fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shadow-sm dark:shadow-none border-b border-outline-variant/10">
                <div className="flex items-center justify-between px-6 py-4 max-w-[1600px] mx-auto">
                    <div className="flex items-center gap-8">
                        <Link to="/admin" className="text-2xl font-black tracking-tighter text-slate-900 dark:text-slate-50">Lumina Admin</Link>
                        <nav className="hidden md:flex gap-6 text-sm font-medium">
                            <span className="text-blue-700 dark:text-blue-400 font-bold border-b-2 border-blue-700 pb-1">Overview</span>
                            <Link to="/products" className="text-slate-600 dark:text-slate-400 hover:text-blue-600 transition-all duration-300">Marketplace</Link>
                        </nav>
                    </div>
                    <div className="flex items-center gap-4">
                        <div className="relative hidden sm:block">
                            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline text-sm">search</span>
                            <input className="bg-surface-container-high border-none rounded-xl pl-10 pr-4 py-2 text-sm focus:ring-2 focus:ring-primary w-64" placeholder="Search data..." type="text" />
                        </div>
            ...
            <div className="flex pt-[72px] min-h-screen">
                ...
                <aside className="w-64 bg-surface-container-low hidden lg:block fixed h-full border-r border-outline-variant/10 z-40">
                    <nav className="p-4 flex flex-col gap-1">
                        <p className="text-[10px] font-bold text-outline tracking-widest uppercase px-4 mb-4 mt-2">Main Menu</p>
                        ...
                        <p className="text-[10px] font-bold text-outline tracking-widest uppercase px-4 mb-4 mt-8">System</p>
